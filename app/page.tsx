            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 w-full max-w-6xl mb-8">
                {posts.map((post) => (
                    <Link
                        ...
                        className="group"
                    >
                        <div className="border rounded-lg shadow-md bg- p-6 hover:shadow-lg transition-shadow duration-300">
                            <h2 className="text-2xl font-semibold text-gray-50 group-hover:underline mb-2">
                                {post.title}
                            </h2>
